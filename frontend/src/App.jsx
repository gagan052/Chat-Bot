      ...
      >
        ...
        {isLoading && (
          <div className="flex justify-start">
            <div className="bg-gray-700 text-gray-100 rounded-lg rounded-bl-none p-4 shadow max-w-[80%] message-enter">
              <div className="flex space-x-2">
                <div className="neon-dot"></div>
                <div className="neon-dot" style={{animationDelay: '0.2s'}}></div>
                <div className="neon-dot" style={{animationDelay: '0.4s'}}></div>
              </div>
            </div>
          </div>
        )}
